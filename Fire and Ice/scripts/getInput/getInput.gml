...
key_action = keyboard_check_pressed(ord("X")) || (gamepad_button_check_pressed(0,gp_face2));

key_fall_thru = (keyboard_check(ord("C")) || (gamepad_button_check_pressed(0,gp_face1))) && key_crouch;